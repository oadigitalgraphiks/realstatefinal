            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted"><a href="{{route('property_purposes.index')}}" class="text-muted text-hover-primary">{{ translate('Property Purposes') }}</a></li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="py-2 ">
                                    ...
                                    <input type="text" placeholder="{{ translate('Name') }}" id="name" name="name"
                                        class="form-control mb-2" value="{{ $property_purpose->getTranslation('name', $lang) }}" required >
                                        @if($errors->has('name'))
                                ...
                                <div class="py-2 ">
                                    ...
                                    <input type="text" placeholder="{{ translate('Slug') }}" id="slug" name="slug"
                                        class="slug form-control mb-2" value="{{ $property_purpose->slug}}" required >
                                        @if($errors->has('slug'))
                                ...
                                <div class="py-2">
                                    ...
                                    <select class="form-select mb-2" data-control="select2" data-hide-search="false" data-placeholder="Select an option" id="parent_id" name="parent_id" data-live-search="true">
                                ...
                                <div class="py-2">
                                    ...
                                    <textarea name="meta_description" rows="5" class="form-control mb-2">{{ $property_purpose->meta_description }}
                                    </textarea>
                                </div>
