    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
         ...
         <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"> {{ translate('Propert Purposses') }}</h1>
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <form class="form d-flex flex-column flex-lg-row gap-7 gap-lg-10" action="{{ route('property_purposes.store') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="text" placeholder="{{ translate('Name') }}" id="name" name="name"
                                        class="title form-control mb-2" required>
                                    @if($errors->has('name'))
                                ...
                                <div class="fv-row mb-2">
                                    ...
                                    <select class="form-select mb-2" data-control="select2" data-hide-search="false"
                                        ...
                                        @foreach ($property_purposes as $property_purpose)
                                            <option value="{{ $property_purpose->id }}">{{ $property_purpose->getTranslation('name') }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="mb-10">
                                    ...
                                    <input type="number" name="order_level" class="form-control mb-2" id="order_level" placeholder="{{ translate('Order Level') }}">
                                </div>
