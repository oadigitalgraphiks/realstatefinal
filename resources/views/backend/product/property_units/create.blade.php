    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <form class="form d-flex flex-column flex-lg-row gap-7 gap-lg-10" action="{{route('property_units.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="py-2">
                                    ...
                                    <input type="text" placeholder="{{ translate('Shortname') }}" name="shortname" class="form-control mb-2" required >
                                </div>

                                <div class="mb-5 fv-row">
                                    <label class="required form-label">{{ translate('Conversion') }}</label>
                                    <input type="text" placeholder="{{ translate('Conversion') }}" name="conversion" class="form-control mb-2" required />
                                </div>
