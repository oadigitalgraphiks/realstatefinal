        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"> {{translate('Property Tour Types')}}</h1>
                    ...
                    <div class="card card-flush">
                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                            ...
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                ...
                                <a href="{{ route('property_tour_types.create') }}" class="btn btn-primary">{{ translate('Add New')}}</a>
                            </div>
                        </div>
                                        ...
                                        @foreach ($data as $key => $item)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="{{ route('property_tour_types.edit', ['id' => $item->id, 'lang' => env('DEFAULT_LANGUAGE')]) }}"
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        data-href="{{ route('property_tour_types.destroy', $item->id) }}"><span class="svg-icon svg-icon-3"><i class="text-danger far fa-trash-alt" ></i></span></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
