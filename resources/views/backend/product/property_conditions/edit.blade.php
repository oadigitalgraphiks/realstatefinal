    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                ...
                <br>
                <form class="form d-flex flex-column flex-lg-row gap-7 gap-lg-10" action="{{route('property_conditions.update', $property_condition->id) }}" method="POST"  >
                  @csrf
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <div class="py-2">
                                    ...
                                    <input type="text" placeholder="{{ translate('Name')}}" name="name" class=" form-control mb-2" value="{{$property_condition->getTranslation('name', $lang) }}" required />
                                    @if($errors->has('name'))
                                ...
                                <div class="py-2">
                                    ...
                                    <input type="text" placeholder="{{ translate('Slug')}}" name="slug" class="slug form-control mb-2" value="{{$property_condition->slug}}" required />
                                    @if($errors->has('slug'))
