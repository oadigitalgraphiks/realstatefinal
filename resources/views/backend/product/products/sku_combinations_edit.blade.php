    ...
    <div class="table-responsive">
        ...
        <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
            ...
            <tr class="fw-bolder text-muted bg-light">
                <th class="min-w-120px text-center">{{translate('Variant')}}</th>
                ...
                @if(strlen($str) > 0)
                    <tr class="variant">
                        ...
                        <td>
                            ...
                            @endphp" min="0" step="0.01" class="form-control mb-2" required>
                        </td>
                        <td>
                            ...
                            @endphp" class="form-control mb-2">
                        </td>
                        <td>
                            ...
                            @endphp" min="0" step="1" class="form-control mb-2" required>
                        </td>
                        <td>
