        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"> {{translate('Property Amenity')}}</h1>
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted"><a href="{{route('property_amenities.index')}}" class="text-muted text-hover-primary"> {{translate('Property Amenity')}}</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="card card-flush">
                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                            ...
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                ...
                                <a href="{{ route('property_amenities.create') }}" class="btn btn-primary">{{ translate('Add New')}}</a>
                            </div>
                        </div>
                                    ...
                                    <tbody class="fw-bold text-gray-600 text-center ">
                                        @foreach ($data as $key => $item)
                                            <tr>
                                                ...
                                                <td> @if($item->logo)<img style="width: 50px;height:20px" src="{{uploaded_asset($item->logo)}}" />@else - @endif </td>
                                                <td>{{$item->getTranslation('name')}}</td>
                                                <td class="text-center">
                                                   
                                                    <a href="{{ route('property_amenities.edit', ['id' => $item->id, 'lang' => env('DEFAULT_LANGUAGE')]) }}"
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        data-href="{{ route('property_amenities.destroy', $item->id) }}"><span class="svg-icon svg-icon-3"><i class="text-danger far fa-trash-alt" ></i></span></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
