    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">{{ translate('Edit Digital Product') }}</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                action="{{route('digitalproducts.update', $product->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-5 fv-row">
                                            ...
                                            <input type="text" placeholder="{{ translate('Name') }}" id="name"
                                                name="name" class="form-control mb-2" value="{{$product->getTranslation('name', $lang)}}" required>
                                        </div>
                                        ...
                                        <div class="mb-5 fv-row">
                                            ...
                                            <input id="kt_ecommerce_add_product_tags" class="form-control mb-2"
                                                name="tags[]"
                                                placeholder="{{ translate('Type & hit enter to add a tag') }}" value="{{ $product->tags }}">
                                        ...
                                        <div class="d-flex flex-wrap gap-5">
                                            ...
                                            <div class="mb-6 fv-row">
                                                ...
                                                <input type="text" class="form-control aiz-date-range mb-2"
                                                    ...
                                                    data-separator=" to " autocomplete="off" value="{{ $start_date.' to '.$end_date }}">
                                            </div>
                                            ...
                                            <div class="fv-row w-100 flex-md-root">
                                                ...
                                                <select class="form-select mb-2" name="discount_type" data-control="select2"
                                                    ...
                                                    <option value="amount" {{$product->discount_type == 'amount' ? "selected" : ''}}>{{ translate('Flat') }}</option>
                                                    <option value="percent" {{$product->discount_type == 'percent' ? "selected" : ''}}>{{ translate('Percent') }}</option>
                                                </select>
                                                <!--end::Select2-->
                                                <!--begin::Description-->
                                                <div class="text-muted fs-7">Set the product discount type.</div>
                                                <!--end::Description-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            <div class="fv-row w-100 flex-md-root">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="number" lang="en" min="0" value="{{$product->discount}}"
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                {{-- <div id="kt_ecommerce_add_product_description" name="description"
                                                    class="min-h-100px mb-2">{{ $product->getTranslation('description', $lang) }}</div> --}}
                                                <!--end::Editor-->
                                            </div>
                                            <!--end::Input group-->
                                        </div>
                                            ...
                                            <div class="fv-row mb-2">
                                                ...
                                                <div class="dropzone" id="kt_ecommerce_add_product_mediaa"
                                                    ...
                                                    <div class="dz-message needsclick">
                                                        ...
                                                        <!--end::Icon-->
                                                        <!--begin::Info-->
                                                        <input type="hidden" name="file" value="{{ $product->file_name }}" class="selected-files">
                                                        <div class="ms-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <textarea name="meta_description" rows="5"
                                                    class="form-control mb-2">{{ $product->meta_description }}</textarea>
                                                <!--end::Editor-->
                                                <!--begin::Description-->
                                            ...
                                            <div class="fv-row mt-5 mb-2">
                                                ...
                                                <div class="dropzone" id="kt_ecommerce_add_product_mediaa"
                                                    ...
                                                    <div class="dz-message needsclick">
                                                        ...
                                                        <!--end::Icon-->
                                                        <!--begin::Info-->
                                                        <input type="hidden" value="{{ $product->meta_img }}" name="meta_img" class="selected-files">
                                                        <div class="ms-4">
                                                            <h3 class="fs-5 fw-bolder text-gray-900 mb-1">
                                                                {{ translate('Drop files here or click
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                to upload') }}.
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <input type="text" class="form-control mb-2" name="slug"
                                                    placeholder="{{ translate('slug') }}" value="{{ $product->slug }}"/>
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                        </div>
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-5 fv-row">
                                            ...
                                            <input type="number" lang="en" min="0" step="0.01"
                                                ...
                                                name="unit_price" value="{{$product->unit_price}}" class="form-control mb-2" required>
                                        </div>
                                        ...
                                        <div class="mb-5 fv-row">
                                            ...
                                            <input type="number" lang="en" min="0" step="0.01"
                                                ...
                                                name="purchase_price" value="{{$product->purchase_price}}" class="form-control mb-2" required>
                                        </div>
                                        ...
                                        <div class="d-flex flex-wrap gap-5">
                                            ...
                                            <div class="fv-row w-100 flex-md-root">
                                                ...
                                                <select class="form-select mb-2" name="tax_type" data-control="select2"
                                                    data-hide-search="true" data-placeholder="Select an option">
                                                    <option value="amount" {{$product->tax_type == 'amount' ? "selected" : ''}}>{{ translate('Flat') }}</option>
                                                    <option value="percent" {{$product->tax_type == 'percent' ? "selected" : ''}}>{{ translate('Percent') }}</option>
                                                </select>
                                                <!--end::Select2-->
                                                <!--begin::Description-->
                                            ...
                                            <div class="fv-row w-100 flex-md-root">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="number" lang="en" min="0" value="{{$product->tax}}"
                                                step="0.01" placeholder="{{ translate('Tax') }}" name="tax" class="form-control mb-2" required>
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                                <div class="text-muted fs-7">
                                                    {{ translate('Set the product VAT about') }}.</div>
