                ...
                <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
                    ...
                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                        ...
                        @if (addon_is_activated('pos_system'))
                            <div class="menu-item me-lg-1">
                                <a class="py-3 btn btn-light-primary font-weight-bold mr-2" href="{{ route('poin-of-sales.index') }}">
                                    <span class="menu-title">{{translate('POS')}}</span>
                                </a>
                            </div>
                        @endif
                        <div class="menu-item me-lg-1">
                        ...
                        <div class="menu-item me-lg-1">
                            <a class="py-3 btn btn-light-secondary font-weight-bold mr-2" href="{{ route('home')}}" target="_blank">
                                <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo2/dist/../src/media/svg/icons/Home/Globe.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                <div class="d-flex align-items-stretch flex-shrink-0">
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                            <!--begin::Heading-->
                            <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('{{static_asset('assets/backend/media/misc/pattern-1.jpg')}}')">
                                <!--begin::Title-->
                                <h3 class="fw-bold text-white px-9 mt-10 mb-6">{{translate("Notifications")}}
                                        @if(Auth::user()->unreadNotifications->count() > 0)
                                ...
                                <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-bold px-9">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link opacity-75 opacity-state-100 pb-4 active" data-bs-toggle="tab" href="#kt_topbar_notifications_3">Orders</a>
                                    </li>
                                </ul>
                                <!--end::Tabs-->
                            </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade show active" id="kt_topbar_notifications_3" role="tabpanel">
                                            ...
                                            @if($notification->type == 'App\Notifications\OrderNotification')
                                                <div class="d-flex flex-stack py-4">
                                                    ...
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Code-->
                                                        <span class="w-70px badge badge-light-success me-4">{{translate('Order code: ')}}</span>
                                                        <!--end::Code-->
                                                        <!--begin::Title-->
                                                        <a href="#" class="text-gray-800 text-hover-primary fw-bold">{{$notification->data['order_code']}}</a>
                                                        <!--end::Title-->
                                                    </div>
                                                    <!--end::Section-->
                                                    <!--begin::Label-->
                                                    <span class="badge badge-light fs-8">{{ date("F j Y, g:i a", strtotime($notification->created_at)) }}</span>
                                                    <!--end::Label-->
                                        ...
                                        @empty
                                            <!--begin::Wrapper-->
                                                <div class="d-flex flex-column px-9">
                                                    ...
                                                    <div class="pt-10 pb-0">
                                                        <!--begin::Title-->
                                                        <h3 class="text-dark text-center fw-bolder">{{ translate('No notification found') }}</h3>
                                                        <!--end::Title-->
                                                    </div>
                                                    <!--end::Section-->
                                                </div>
                                    ...
                                    <!--begin::View more-->
                                    <div class="py-3 text-center border-top">
                                        <a href="{{ route('admin.all-notification') }}" class="btn btn-color-gray-600 btn-active-color-primary">View All
                                            <!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
                                            <span class="svg-icon svg-icon-5">
																<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
																	<rect opacity="0.5" x="18" y="13" width="13" height="2" rx="1" transform="rotate(-180 18 13)" fill="black" />
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                            <img src="{{ uploaded_asset(Auth::user()->avatar_original) }}"
                                   onerror="this.onerror=null;this.src='{{ static_asset('assets/img/avatar-place.png') }}';" alt="user" />
                        </div>
                        <!--begin::Menu-->
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img alt="Logo"   src="{{ uploaded_asset(Auth::user()->avatar_original) }}"
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="fw-bolder d-flex align-items-center fs-5">{{Auth::user()->name}}
                                            <span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">{{Auth::user()->user_type}}</span></div>
                                        <a href="{{ route('profile.index') }}" class="fw-bold text-muted text-hover-primary fs-7">{{Auth::user()->email}}</a>
                                    </div>
                                    <!--end::Username-->
                                </div>
                            </div>
                            ...
                            <div class="menu-item px-5 d-none" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start" id="lang-change">
                                <a href="javascript:void(0);" class="menu-link px-5">
                                    ...
                                    <img class="w-15px h-15px rounded-1 ms-2" src="{{ static_asset('assets/img/flags/'.$locale.'.png') }}" alt="" /></span></span>
                                </a>
                                <!--begin::Menu sub-->
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="javascript:void(0)" data-flag="{{ $language->code }}" class="menu-link d-flex px-5 @if($locale == $language->code) active @endif">
                                            <span class="symbol symbol-20px me-4">
                                                <img class="rounded-1" src="{{ static_asset('assets/img/flags/'.$language->code.'.png') }}" alt="{{ $language->name }}" />
                            ...
                            <div class="menu-item px-5 my-1 d-none">
                                <a href="{{ route('profile.index') }}" class="menu-link px-5">{{translate('Account Settings')}}</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-5">
                                <a href="{{ route('logout')}}" class="menu-link px-5">{{translate('Sign Out')}}</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu separator-->
                            <div class="separator my-2"></div>
                            ...
                            <div class="menu-item px-5 d-none">
                                <div class="menu-content px-5">
                                    <label class="form-check form-switch form-check-custom form-check-solid pulse pulse-success" for="kt_user_menu_dark_mode_toggle">
                                        <input class="form-check-input w-30px h-20px" type="checkbox" value="1" name="mode" id="kt_user_menu_dark_mode_toggle" data-kt-url="{{ route("admin.dashboard") }}" />
