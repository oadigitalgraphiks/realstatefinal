        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div  class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"> {{ translate('Inquiry') }}</h1>
                            ...
                            <div class="card-body pt-0">
                                <div class="pb-3" >
                                    ...
                                    <p class="mt-1"><strong>{{ translate('Name')}} </strong>
                                       @if($data->user) 
                                        <a href="{{route('customers.show',$data->user->id)}}"> {{$data->user->name}}</a> 
                                       @else 
                                        {{$data->name}}
                                       @endif 
                                    </p>
                               ...
                               <div class="text-center" >
                                <a class="btn btn-primary" href="{{route('property_inquiries.index')}}"> {{ translate('Back') }}</a>
                               </div>
                            </div>
                        </div>
                    </div>
