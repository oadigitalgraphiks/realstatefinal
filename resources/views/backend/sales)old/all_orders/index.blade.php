...
{{--                            {{ ($key+1) + ($orders->currentPage() - 1)*$orders->perPage() }}--}}
                                ...
                                <td data-kt-ecommerce-order-filter="order_id">
                                    <a href="{{route('all_orders.show', encrypt($order->id))}}" class="text-gray-800 text-hover-primary fw-bolder">{{ $order->code }}</a>
                                </td>
                                <!--end::Order ID=-->
                                <!--begin::Customer=-->
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="{{route('all_orders.show', encrypt($order->id))}}" class="text-gray-800 text-hover-primary fs-5 fw-bolder">@if ($order->user != null)
                                                    {{ $order->user->name }}
                                                @else
                        ...
                        @endif
                                ...
                                <td class="text-center">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="{{route('all_orders.show', encrypt($order->id))}}" class="menu-link px-3">{{ translate('View') }}</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
