        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Language Create</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                    ...
                    <form class="form-horizontal" action="{{ route('languages.store') }}" method="POST"
                                    ...
                                    @foreach (\File::files(base_path('public/assets/img/flags')) as $path)
                                        @if (!in_array(pathinfo($path)['filename'], $languagesArray))
                                            <option value="{{ pathinfo($path)['filename'] }}">
                                                <div class=''><img
                                                        src='{{ static_asset('assets/img/flags/' . pathinfo($path)['filename'] . '.png') }}'
                                                        class='mr-2'><span>{{ strtoupper(pathinfo($path)['filename']) }}</span>
                                                </div>
                                            </option>
                                        @endif
                                    @endforeach
                        ...
                        <div class="row mb-2">
                            <div class="col-xl-3">
                                ...
                                <code>
                                    <a target="_blank"
                                        href="https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes">{{ translate('Links for ISO 639-1 codes') }}</a>
                                </code>
                            </div>
                            <div class="col-xl-9">
