        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">App Translation</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control value" style="width:100%"
                                                name="values[{{ $translation->lang_key }}]" @if (($traslate_lang = \App\Models\AppTranslation::where('lang', $language->app_lang_code)->where('lang_key', $translation->lang_key)->latest()->first()) != null)
