            ...
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <ul class="nav nav-tabs nav-fill border-light">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-reset @if ($language->code == $lang) active @else bg-soft-dark border-light border-left-0 @endif py-3" href="{{ route('admin_menu.edit', ['id'=>$adminMenu->id, 'lang'=> $language->code] ) }}">
                    ...
                    <div class="card card-flush py-4">
                        <div class="card-body p-0">
                            <form class="p-4" action="{{ route('admin_menu.update', $adminMenu->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="">
                                        ...
                                        data-live-search="true">
                                            ...
                                            @foreach ($admin_menus as $admin_menu)
                                                <option {{$adminMenu->parent_id == $admin_menu->id ? 'selected' : null}} value="{{ $admin_menu->id }}">{{ $admin_menu->getTranslation('name') }}</option>
                                                @foreach ($admin_menu->childrens as $sub_menu)
                                                    <option {{$adminMenu->parent_id == $sub_menu->id ? 'selected' : null}} value="{{ $sub_menu->id }}">- {{ $sub_menu->getTranslation('name') }}</option>
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="">
                                        <input type="text" placeholder="{{translate('Name')}}" name="name" class="form-control" required value="{{$adminMenu->getTranslation('name')}}">
                                    </div>
                                </div>
                                <div class="mb-5">
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="">
                                        <input type="text" placeholder="{{translate('Addon Name')}}" name="addon_name" value="{{ $adminMenu->addon_name }}" class="form-control">
                                        <div class="text-danger mt-2 fw-bold text-center">
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="">
                                        <input type="text" placeholder="{{translate('Route')}}" name="route" class="form-control" value="{{$adminMenu->route}}">
                                        <div class="text-danger mt-2 fw-bold text-center">
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="">
                                        <input required type="number" min="1" placeholder="{{translate('Sort')}}" name="sort" class="form-control" value="{{$adminMenu->sort}}">
                                    </div>
                                </div>
