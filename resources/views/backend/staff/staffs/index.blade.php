    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">All Staffs</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">All Staffs</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                            ...
                            <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                ...
                                <thead>
                                    ...
                                    <tr class="text-center text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="text-center min-w-75px">{{ translate('Email') }}</th>
                                        <th class="text-center min-w-175px">{{ translate('Phone') }}</th>
                                        <th class="text-center min-w-150px">{{ translate('Role') }}</th>
                                        ...
                                        @if($staff->user != null)
                                            <tr>
                                                ...
                                                <td class="text-center pe-0">
                                                    <span class="fw-bolder">{{ ($key+1) + ($staffs->currentPage() - 1)*$staffs->perPage() }}</span>
                                                </td>
                                                <!--begin::Category=-->
                                                <td class="text-center pe-0">
                                                    <!--begin::Title-->
