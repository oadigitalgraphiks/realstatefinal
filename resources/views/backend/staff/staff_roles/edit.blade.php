        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Role Edit</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                                        ...
                                        <div class="card-header border align-items-center py-5 gap-2 gap-md-5">
                                            ...
                                            <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid mb-5 d-block">
                                                <span class="form-check-label ms-0 fw-bolder fs-6 text-gray-700 ps-5">
                                                    <input class="form-check-input main-menu" type="checkbox" {{in_array($main_menu->id, $role->menus->pluck('id')->toArray()) ? 'checked' : null}} name="role_menus[]" value="{{$main_menu->id}}">
                                                </span>
                                            </label>
                                            {{-- <label class="aiz-checkbox">
                                                <input {{in_array($main_menu->id, $role->menus->pluck('id')->toArray()) ? 'checked' : null}} type="checkbox" name="role_menus[]" value="{{$main_menu->id}}" class="main-menu">
                                                <h5>{{$main_menu->name}}</h5>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-header mt-2 p-0">
                                                            ...
                                                            <div class="col-md-8 text-center">
                                                                <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid mb-5 d-block">
                                                                    <span class="form-check-label ms-0 fw-bolder fs-6 text-gray-700 ps-5">
                                                                        <input class="form-check-input sub-menu" type="checkbox" {{in_array($sub_menu->id, $role->menus->pluck('id')->toArray()) ? 'checked' : null}} name="role_menus[]" value="{{$sub_menu->id}}">
                                                                    </span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                                ...
                                                                @foreach(\App\Models\Permission::where('admin_menu_id',$sub_menu->id)->where('status',1)->get() as $permission)
                                                                    ...
                                                                    <div class="col-md-8 ml-3">
                                                                        <label class="form-check form-switch form-switch-sm form-check-solid mb-5 d-block">
                                                                            <span class="form-check-label ms-0 fw-bolder fs-6 text-gray-700 ps-5">
                                                                                <input class="form-check-input inner-fields" type="checkbox" {{in_array($permission->id, $role->permissions->pluck('id')->toArray()) ? 'checked' : null}}  name="role_permissions[]" value="{{$permission->id}}">
                                                                            </span>
                                                                        </label>
                                                                    </div>
                                                                @endforeach
