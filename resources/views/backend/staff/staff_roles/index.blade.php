        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">All Role</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-title">
                            <h2 class="h3">{{translate('All Role')}}</h2>
                        </div>
                        <!--end::Card title-->
                        <!--begin::Card toolbar-->
                                    ...
                                    @foreach ($roles as $key => $role)
                                            <tr>
                                                ...
                                                <td class="text-center pe-0">
                                                    <span class="fw-bolder">{{ ($key+1) + ($roles->currentPage() - 1)*$roles->perPage() }}</span>
                                                </td>
                                                <!--begin::Category=-->
                                                <td class="text-center pe-0">
                                                    <!--begin::Title-->
                                                ...
                                                <td class="text-center">
                                                    <a href="{{route('roles.edit', ['id'=>$role->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}"
