                            ...
                            <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                ...
                                <thead>
                                    ...
                                    <tr class="text-center text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="text-center min-w-75px">{{ translate('Category') }}</th>
                                        {{-- <th class="text-center min-w-175px">{{ translate('Short Description') }}</th> --}}
                                    ...
                                    @foreach ($blogs as $key => $blog)
                                        <tr>
                                            ...
                                            <td class="text-center pe-0">
                                                <span
                                                    class="fw-bolder">{{ ($key+1) + ($blogs->currentPage() - 1) * $blogs->perPage() }}</span>
                                            </td>
                                            <!--begin::Category=-->
                                            <td>
                                                <div class="d-flex">
                                                    <div class="ms-5">
                                                        <!--begin::Title-->
                                                        <a href="{{ route('blog.edit',$blog->id)}}" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">
                                                            {{ $blog->title }}
                                                        </a>
                                                        <!--end::Title-->
                                                    </div>
                                            ...
                                            <td class="text-center pe-0" data-order="32">
                                                <span class="fw-bolder ms-3">
                                                    ...
                                                    <input class="form-check-input" onchange="change_status(this)"
                                                        value="{{ $blog->id }}" type="checkbox"
