...
<div class="d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Blog Create</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Blog Create</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <form class="form d-flex flex-column flex-lg-row gap-7 gap-lg-10" action="{{ route('blog.store') }}"
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="fv-row mt-5 mb-2">
                                <label class="form-label">{{ translate('Thumbnail Image') }} <b> (1103 x 906) </b></label>
                                <!--begin::Dropzone-->
                                ...
                                <div class="dropzone" id="kt_ecommerce_add_product_mediaa"
                                    ...
                                    <div class="dz-message needsclick">
                                        ...
                                        <div class="ms-4">
                                            <h3 class="fs-5 fw-bolder text-gray-900 mb-1">{{translate('Drop files here or click
                                                to upload')}}.</h3>
                                            <span class="fs-7 fw-bold text-gray-400">{{translate('Banner Image size')}} <small>(1500 x 699)</small></span>
                                        </div>
                                        <!--end::Info-->
                                    </div>
                                </div>
                            ...
                            <div class="mb-5 fv-row d-none">
                                ...
                                <textarea name="short_description" rows="2" class="aiz-text-editor"></textarea>
                            </div>

                            <div class="mb-5 fv-row">
                                <label class="form-label">{{ translate('Description') }}</label>
                                <textarea name="description" rows="5" class="aiz-text-editor"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <!--begin::Input group-->
                                <div class="mb-5 fv-row">
                                    <label class="required form-label">{{ translate('Meta Title') }}</label>
                                    ...
                                    <div class="dropzone" id="kt_ecommerce_add_product_mediaa"
                                        ...
                                        <div class="dz-message needsclick">
                                            ...
                                            <div class="ms-4">
                                                <h3 class="fs-5 fw-bolder text-gray-900 mb-1">{{translate('Drop files here or click
                                                    to upload')}}.</h3>
                                                <span class="fs-7 fw-bold text-gray-400">{{translate('Meta image size')}} (200x200)+</span>
                                            </div>
                                            <!--end::Info-->
                                        </div>
                                    </div>
