       ...
       <div class="toolbar" id="kt_toolbar">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <form class="form d-flex flex-column flex-lg-row gap-7 gap-lg-10" action="{{ route('property_nested_areas.store') }}" method="POST">
                    @csrf
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="py-2">
                                    ...
                                    <select class="form-select mb-2" data-placeholder="Select Country" id="country_id">
                                    </select>
                                </div>

                                <div class="py-2">
                                    <label class="required form-label">{{ translate('State') }}</label>
                                    <select data-control="select2"  class="form-select mb-2"  data-placeholder="Select State" id="state_id">
                                ...
                                <div class="py-2">
                                    ...
                                    <select data-control="select2"  class="form-select mb-2"  data-placeholder="Select City" id="city_id">
                                ...
                                <div class="py-2">
                                    ...
                                    <select required  data-control="select2" required class="form-select mb-2"  data-placeholder="Select Area" name="area_id" id="area_id">
                                     
                                    </select>
                                </div>

                                <div class="py-2">
                                    <label class="required form-label">{{ translate('Status') }}</label>
                                ...
                                <div class="py-2">
                                    <label class="required form-label">{{ translate('Featured') }}</label>
