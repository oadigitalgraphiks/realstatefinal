        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Payment History</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-title">
                            <div class="d-flex align-items-center position-relative my-1">
                                <h2>{{ \App\Models\Seller::find($payments->first()->seller_id)->user->name }} ({{ \App\Models\Seller::find($payments->first()->seller_id)->user->shop->name }})</h2>
                            </div>
                        </div>
                            ...
                            <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                ...
                                <thead>
                                    ...
                                    <tr class="text-center text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="text-center min-w-175px">{{ translate('Payment Details') }}</th>
                                    </tr>
                                    <!--end::Table row-->
                                </thead>
                                <!--end::Table head-->
