                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-ecommerce-order-filter="search" class="form-control form-control-solid w-250px ps-14"  id="update_tracking_code" name="update_tracking_code"  value="{{ $order->tracking_code }}"  placeholder="{{translate('Tracking Code (optional)')}}"/>
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--end::Card title-->
                            ...
                            @if (addon_is_activated('delivery_boy'))
                                <div class="input-group w-250px">
                                    @if($delivery_status == 'pending' || $delivery_status == 'confirmed' || $delivery_status == 'picked_up')
                                        <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Status" data-kt-ecommerce-order-filter="status" name="assign_deliver_boy" id="assign_deliver_boy">
                                    ...
                                    @else
                                        <input type="text" class="form-control mb-2" value="{{ optional($order->delivery_boy)->name }}" disabled>
                                    @endif
                                </div>
                            @endif
                            <div class="input-group w-250px">
                                @if($delivery_status != 'delivered' && $delivery_status != 'cancelled')
                                    <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Status" data-kt-ecommerce-order-filter="status" name="delivery_status" id="update_delivery_status">
                                ...
                                @else
                                    <input type="text" class="form-control mb-2" value="{{ $delivery_status }}" disabled>
                                @endif

                            </div>
                            <div class="input-group w-250px">
                                <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Status" data-kt-ecommerce-order-filter="status" name="update_payment_status" id="update_payment_status">
						 	...
						 	<svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bolder text-end">
                                                ...
                                                @else
                                                    {{ ucfirst(str_replace('_', ' ', $order->payment_type)) }} <img src="{{ static_asset('assets/backend/media/svg/card-logos/visa.svg')}}" class="w-50px ms-2" />
                                                @endif
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bolder text-end">
                                                <a href="#" class="text-gray-600 text-hover-primary">@if ($order->user != null){{ $order->user->email }}@endif</a>
                                            </td>
                                        </tr>
                                        <!--end::Payment method-->
                                        <!--begin::Date-->
                                        <tr>
                                            ...
                                            <td class="fw-bolder text-end">@if ($order->user != null){{ $order->user->phone }}@endif</td>
                                        </tr>
                                        <!--end::Date-->
                                        </tbody>
                                        <!--end::Table body-->
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bolder text-end">
                                                <a href="#" class="text-gray-600 text-hover-primary">{{ $order->code }}</a>
                                            </td>
                                        </tr>
                                        <!--end::Invoice-->
                                        <!--begin::Shipping-->
                                        <tr>
                                            <td class="text-muted">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <!--end::Svg Icon-->{{translate('Order Status')}}
                                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="" data-bs-original-title="View the Order Status generated by this order."></i></div>
                                            </td>
                                            <td class="fw-bolder text-end">
                                                <a href="#" class="text-gray-600 text-hover-primary">
                                                    @if($delivery_status == 'delivered')
                                                        <div class="badge badge-light-success">{{ translate(ucfirst(str_replace('_', ' ', $delivery_status))) }}</div>
                                                    @else
                                                        <div class="badge badge-light-primary">{{ translate(ucfirst(str_replace('_', ' ', $delivery_status))) }}</div>
                                                    @endif
                                                </a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td class="text-muted">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <!--end::Svg Icon-->Grand Total
                                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="" data-bs-original-title="Grand Total by customer when purchasing this order."></i></div>
                                            </td>
                                            <td class="fw-bolder text-end">{{ single_price($order->grand_total) }}</td>
                                        </tr>
                                        <!--end::Rewards-->
                                        </tbody>
                                        <!--end::Table body-->
                        ...
                        <div class="tab-pane fade show active" id="kt_ecommerce_sales_order_summary" role="tab-panel">
                            ...
                            <div class="d-flex flex-column gap-7 gap-lg-10">
                                ...
                                <div class="card card-flush py-4 flex-row-fluid overflow-hidden">
                                    ...
                                    <div class="card-header">
                                        <div class="card-title">
                                            <h2>{{translate('Order')}} {{$order->code}}</h2>
                                        </div>
                                    </div>
                                    <!--end::Card header-->
                                    <!--begin::Card body-->
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                                ...
                                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                    <th class="">#</th>
                                                    <th class="min-w-175px">{{translate('Item')}}</th>
                                                    <th class="min-w-100px text-end">{{translate('Delivery Type')}}</th>
                                                    <th class="min-w-70px text-end">{{translate('Qty')}}</th>
                                                    <th class="min-w-100px text-end">{{translate('Price')}}</th>
                                                    <th class="min-w-100px text-end">{{translate('Total')}}</th>
                                                </tr>
                                                </thead>
                                                <!--end::Table head-->
                                                <!--begin::Table body-->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if ($orderDetail->product != null && $orderDetail->product->auction_product == 0)
                                                                <div class="d-flex align-items-center">
                                                                    <a href="{{ route('product', $orderDetail->product->slug) }}" class="symbol symbol-50px">
                                                                        <span class="symbol-label" style="background-image:url({{ uploaded_asset($orderDetail->product->thumbnail_img) }});"></span>
                                                                    </a>
                                                                    <div class="ms-5">
                                                                        <a href="{{ route('product', $orderDetail->product->slug) }}" class="fw-bolder text-gray-600 text-hover-primary">{{ $orderDetail->product->getTranslation('name') }}</a>
                                                                        <div class="fs-7 text-muted">{{translate('Variations')}}: {{ $orderDetail->variation }}</div>
                                                                    </div>
                                                                </div>
                                                            @elseif ($orderDetail->product != null && $orderDetail->product->auction_product == 1)
                                                                <div class="d-flex align-items-center">
                                                                    <a href="{{ route('auction-product', $orderDetail->product->slug) }}" class="symbol symbol-50px">
                                                                        <span class="symbol-label" style="background-image:url({{ static_asset('assets/backend/media//stock/ecommerce/1.gif')}});"></span>
                                                                    </a>
                                                                    <div class="ms-5">
                                                                        <a href="{{ route('auction-product', $orderDetail->product->slug) }}" class="fw-bolder text-gray-600 text-hover-primary">{{ $orderDetail->product->getTranslation('name') }}</a>
                                                                        <div class="fs-7 text-muted">{{translate('v')}}: {{ $orderDetail->variation }}</div>
                                                                    </div>
                                                                </div>
                                                            @else
                                                        ...
                                                        <!--end::Product-->
                                                        <!--begin::SKU-->
                                                        <td class="text-end">@if ($order->shipping_type != null && $order->shipping_type == 'home_delivery')
                                                        ...
                                                        <!--end::Quantity-->
                                                        <!--begin::Price-->
                                                        <td class="text-end">{{ single_price($orderDetail->price/$orderDetail->quantity) }}</td>
                                                        <!--end::Price-->
                                                        <!--begin::Total-->
                                                        <td class="text-end">{{ single_price($orderDetail->price) }}</td>
                                                        <!--end::Total-->
                                                    </tr>
                                                @endforeach
                                                ...
                                                <!--begin::Subtotal-->
                                                <tr>
                                                    <td colspan="5" class="text-end">{{translate('Sub Total')}}</td>
                                                    <td class="text-end">{{ single_price($order->orderDetails->sum('price')) }}</td>
                                                </tr>
                                                <!--end::Subtotal-->
                                                <!--begin::VAT-->
                                                <tr>
                                                    <td colspan="5" class="text-end">{{translate('Tax')}}</td>
                                                    <td class="text-end">{{ single_price($order->orderDetails->sum('tax')) }}</td>
                                                </tr>
                                                <!--end::VAT-->
                                                <!--begin::Shipping-->
                                                <tr>
                                                    <td colspan="5" class="text-end">{{translate('Shipping Rate')}}</td>
                                                    <td class="text-end">{{ single_price($order->orderDetails->sum('shipping_cost')) }}</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="5" class="text-end">{{translate('Coupon')}}</td>
                                                    <td class="text-end">{{ single_price($order->coupon_discount) }}</td>
                                                </tr>
                                                <!--end::Shipping-->
                                                <!--begin::Grand total-->
                                                <tr>
                                                    <td colspan="5" class="fs-3 text-dark text-end">{{translate('Grand Total')}}</td>
                                                    <td class="text-dark fs-3 fw-boldest text-end"> {{ single_price($order->orderDetails->sum('price') + $order->orderDetails->sum('tax') + $order->orderDetails->sum('shipping_cost')) }}</td>
                                                </tr>
                                                <!--end::Grand total-->
                                                </tbody>
                                                <!--end::Table head-->
