            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">{{ translate('Pickup Point Orders') }}</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                            ...
                            @foreach ($orders as $key => $order_id)
                                ...
                                <!--begin::Checkbox-->
                                    ...
                                    <td data-kt-ecommerce-order-filter="order_id">
                                        <a href="{{ route('pick_up_point.order_show', encrypt($order->id)) }}" class="text-gray-800 text-hover-primary fw-bolder">{{ $order->code }} @if($order->viewed == 0) <span class="badge badge-light-info">{{translate('New')}}</span>@endif</a>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                <a href="{{ route('pick_up_point.order_show', encrypt($order->id)) }}">
                                            ...
                                            <div class="ms-5">
                                                <!--begin::Title-->
                                                <a href="{{ route('pick_up_point.order_show', encrypt($order->id)) }}" class="text-gray-800 text-hover-primary fs-5 fw-bolder">@if ($order->user != null)
                                                        {{ $order->user->name }}
                                                    @else
                                    ...
                                    <td class="text-center pe-0">
                                        <span class="fw-bolder">{{ single_price($order->orderDetails->sum('price') + $order->orderDetails->sum('tax')) }}</span>
                                    </td>
                                    <!--begin::Status=-->
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('pick_up_point.order_show', encrypt($order->id)) }}" class="menu-link px-3">{{ translate('View') }}</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
