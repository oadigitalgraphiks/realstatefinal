                ...
                <div class="card card-flush">
                        ...
                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                            ...
                            <div class="card-title">
                                ...
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text" data-kt-ecommerce-order-filter="search"
                                        class="form-control form-control-solid w-250px ps-14" id="search" name="search"
                            ...
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                ...
                                <div class="input-group w-250px">
                                    ...
                                    <input type="text" class="aiz-date-range form-control form-control-solid w-250px ps-14"
                                ...
                                <div class="input-group w-250px">
                                    <select class="form-select form-select-solid" data-control="select2"
                                        ...
                                        data-kt-ecommerce-order-filter="status" name="delivery_status" id="delivery_status">
                                        <option value="">{{ translate('Filter by Delivery Status') }}</option>
                                        <option value="pending" @if ($delivery_status == 'pending') selected @endif>{{ translate('Pending') }}</option>
                                        <option value="confirmed" @if ($delivery_status == 'confirmed') selected @endif>{{ translate('Confirmed') }}
                                        </option>
                                        <option value="picked_up" @if ($delivery_status == 'picked_up') selected @endif>{{ translate('Picked Up') }}
                                        </option>
                                        <option value="on_the_way" @if ($delivery_status == 'on_the_way') selected @endif>{{ translate('On The Way') }}
                                        </option>
                                        <option value="delivered" @if ($delivery_status == 'delivered') selected @endif>{{ translate('Delivered') }}
                                        </option>
                                        <option value="cancelled" @if ($delivery_status == 'cancelled') selected @endif>{{ translate('Cancel') }}
                                        </option>
                                    </select>
                                    ...
                                    <div class="me-0">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="#" onclick="bulk_delete()"
                                                    class="menu-link flex-stack px-3">{{ translate('Delete selection') }}
                                ...
                                @foreach ($orders as $key => $order)
                                    <tr>
                                        ...
                                        <td data-kt-ecommerce-order-filter="order_id">
                                            <a href="{{ route('all_orders.show', encrypt($order->id)) }}"
                    ...
                    <td class="text-center">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                            ...
                            <div class="menu-item px-3">
                                <a href="{{ route('all_orders.show', encrypt($order->id)) }}"
                                    class="menu-link px-3">{{ translate('View') }}</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="{{ route('invoice.download', $order->id) }}"
                                    class="menu-link px-3">{{ translate('Download') }}</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link px-3 confirm-delete"
                                    ...
                                    data-kt-ecommerce-order-filter="delete_row">{{ translate('Delete') }}</a>
                            </div>
                            <!--end::Menu item-->
                        </div>
                        <!--end::Menu-->
