        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Pages</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-title">
                            <h2>{{ translate('Website Pages') }}</h2>
                        </div>
                        <!--end::Card title-->
                        <!--begin::Card toolbar-->
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5 d-none">
                            ...
                            <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                ...
                                <thead>
                                    ...
                                    <tr class="text-center text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="text-center min-w-75px">{{ translate('URL') }}</th>
                                        <th class="text-center min-w-175px">{{ translate('Actions') }}</th>
                                    </tr>
                                    <!--end::Table row-->
                                </thead>
                                <!--end::Table head-->
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td class="text-center">
                                                ...
                                                @elseif ($page->type == 'about')
                                                    <a href="{{ route('custom-pages.edit', ['id' => $page->slug, 'lang' => env('DEFAULT_LANGUAGE'), 'page' => 'about']) }}"
                                                        class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                        <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                                                        <span class="svg-icon svg-icon-primary svg-icon-2x">
                                                            <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo2/dist/../src/media/svg/icons/Design/Edit.svg--><svg
                                                ...
                                                @elseif ($page->type == 'contact_us')
                                                    <a href="{{ route('custom-pages.edit', ['id' => $page->slug, 'lang' => env('DEFAULT_LANGUAGE'), 'page' => 'contact_us']) }}"
                                                        class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                        <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                                                        <span class="svg-icon svg-icon-primary svg-icon-2x">
                                                            <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo2/dist/../src/media/svg/icons/Design/Edit.svg--><svg
                                                ...
                                                @if ($page->type == 'custom_page')
                                                    <a href="javascript:void(0)"
                                                        class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 confirm-delete"
