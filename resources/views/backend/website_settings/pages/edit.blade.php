...
<div class="d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Page Edit</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <form class="form d-flex flex-column flex-lg-row gap-7 gap-lg-10" action="{{ route('custom-pages.update', $page->id) }}"
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <div class="card-body pt-0">
                            <div class="mb-5 fv-row">
                                ...
                                <input type="text" placeholder="{{ translate('Title') }}" id="title" name="title"
                                    class="form-control mb-2" value="{{ $page->getTranslation('title',$lang) }}" required>
                            </div>
                        </div>
                            ...
                            <div class="mb-5 fv-row">
                                ...
                                <div class="input-group d-block d-md-flex">
                                    ...
                                    @else
                                        ...
                                        <input type="text" class="form-control w-100 w-md-auto" placeholder="{{ translate('Slug') }}" value="{{ $page->slug }}" name="slug" disabled>
                                    @endif
                                </div>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            <div class="mb-5 fv-row">
                                ...
                                <input type="text" placeholder="{{ translate('Meta Title') }}" id="meta_title" name="meta_title"
                                    class="form-control mb-2" value="{{ $page->meta_title }}">
                            </div>
                        </div>
                        ...
                        <div class="card-body pt-0">
                            <div class="mb-5 fv-row">
                                ...
                                <textarea
                                    class="form-control"
                                    placeholder="{{translate('Keyword, Keyword')}}"
                                    data-min-height="300"
                                    name="keywords"
                                >{!! $page->keywords !!}</textarea>
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" id="kt_ecommerce_add_category_submit" class="btn btn-primary">
                            <span class="indicator-label">{{ translate('Update Page') }}</span>
