...
@section('content')
            ...
            <div class="col-xl-3">
                ...
                <a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">{{ \App\Models\Order::count() }}</div>
                        <div class="fw-bold text-gray-100">{{ translate('Total') }} {{ translate('Orders') }}</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Statistics Widget 5-->
            ...
            <div class="col-xl-3">
                ...
                <a href="#" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{ \App\Models\Category::count() }}</div>
                        <div class="fw-bold text-white">{{ translate('Total') }} {{ translate('Product category') }}</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Statistics Widget 5-->
            ...
            <div class="col-xl-3">
                ...
                <a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <div class="fw-bold text-white">{{ translate('Total') }} {{ translate('sssProduct Brands') }}</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Statistics Widget 5-->
                ...
                <div class="card card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-body pt-5">
                        ...
                        <div class="text-center w-100 position-relative z-index-1" style="margin-top: -130px">
                            ...
                            <!--begin::Action-->
                            <div class="mb-9 mb-xxl-1">
                                <a href='#' class="btn btn-info fw-bold" data-bs-toggle="modal" data-bs-target="#kt_modal_invite_friends">Increase Users</a>
                            </div>
                            <!--ed::Action-->
                        </div>
                        <!--end::Content-->
                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-body pt-5">
                        ...
                        <div class="text-center w-100 position-relative z-index-1" style="margin-top: -130px">
                            ...
                            <!--begin::Action-->
                            <div class="mb-9 mb-xxl-1">
                                <a href='#' class="btn btn-success fw-bold" data-bs-toggle="modal" data-bs-target="#kt_modal_invite_friends">Increase Users</a>
                            </div>
                            <!--ed::Action-->
                        </div>
                        <!--end::Content-->
    ...
    alt="{{  $product->getTranslation('name')  }}" onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';" class="h-50 align-self-center" alt="" />
																				</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="{{ route('product', $product->slug) }}" class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{ $product->getTranslation('name') }}</a>
                                                    <span class="text-muted fw-bold d-block">Movie Creator</span>
                                                </td>

                                                <td class="text-end text-muted fw-bold">@if(home_base_price($product) != home_discounted_base_price($product))
                                                        <del class="fw-600 opacity-50 mr-1">{{ home_base_price($product) }}</del>
                                                    @endif
                                                    <span class="fw-700 text-primary">{{ home_discounted_base_price($product) }}</span></td>
                                                <td class="text-end">
                                                    <span class="badge badge-light-success">New</span>
                                                </td>
                                                <td class="text-end">
                                                    <a href="{{ route('product', $product->slug) }}" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary">
