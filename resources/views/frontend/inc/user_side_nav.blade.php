<div class="dashboard-menu">
    <ul class="nav flex-column" role="tablist">
        <li class="text-center nav-item" style="border: none;">
            @if (Auth::user()->avatar_original != null)
                <img src="{{ uploaded_asset(Auth::user()->avatar_original) }}" class="profile-img " onerror="this.onerror=null;this.src='{{ static_asset('assets/img/avatar-place.png') }}';"/>
            @else
                <img src="{{ static_asset('assets/img/avatar-place.png') }}" class="profile-img " onerror="this.onerror=null;this.src='{{ static_asset('assets/img/avatar-place.png') }}';"/>
            @endif
                <br>
            <a>{{Auth::user()->name}}</a>
        </li>
        ...
        @endphp
        <li class="nav-item">
            <a href="{{ route('purchase_history.index') }}" class="nav-link {{ areActiveRoutes(['purchase_history.index'])}}">
        ...
        <li class="nav-item">
            <a class="nav-link {{ areActiveRoutes(['orders.track'])}}"
                    href="{{route('orders.track')}}"
                    aria-selected="true"><i class="fi-rs-user mr-10"></i>{{ translate('Track Order') }}</a>
            {{-- <a class="nav-link" id="track-orders-tab" data-bs-toggle="tab" href="#track-orders" role="tab" aria-controls="track-orders" aria-selected="false"><i class="fi-rs-shopping-cart-check mr-10"></i>Track Your Order</a> --}}
        </li>
        <li class="nav-item">
            <a class="nav-link {{ areActiveRoutes(['wishlists.index'])}}" href="{{ route('wishlists.index') }}" aria-selected="true">
                <i class="fi-rs-heart mr-10"></i>
                {{translate('My WishList')}}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ areActiveRoutes(['address.list'])}}" href="{{route('address.list')}}" aria-selected="true">
        ...
        <li class="nav-item">
            <a href="{{ route('profile') }}" class="nav-link {{ areActiveRoutes(['profile'])}}">
                ...
                <span class="aiz-side-nav-text">{{translate('Account details')}}</span>
            </a>
        </li>
        <li class="nav-item">
