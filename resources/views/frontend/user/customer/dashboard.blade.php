...
<div class="tab-pane fade active show" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
    <div class="card">
        ...
        <div class="card-body">
            <p>
                From your account dashboard. you can easily check &amp; view your <a href="{{ route('purchase_history.index') }}">recent orders</a>,<br />
                manage your <a href="{{route('address.list')}}">shipping and billing addresses</a> and <a href="{{ route('profile') }}">edit your password and account details.</a>
            </p>
        </div>
    </div>
</div>
...
<div class="row gutters-10 d-none">
    <div class="col-md-4">
