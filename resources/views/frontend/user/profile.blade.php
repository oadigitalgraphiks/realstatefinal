                ...
                <form action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label>{{ translate('Your Name') }}<span class="required">*</span></label>
                            <input type="text" class="form-control" placeholder="{{ translate('Your Name') }}" name="name" value="{{ Auth::user()->name }}">
                        </div>
                        <div class="form-group col-md-6">
                            <label>{{translate("Phone")}} <span class="required">*</span></label>
                            <input type="tel" class="form-control" placeholder="{{ translate('Your Phone')}}" name="phone" value="{{ Auth::user()->phone }}">
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            <label>{{ translate('Confirm Password') }} <span class="required">*</span></label>
