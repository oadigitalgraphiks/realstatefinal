...
<div class="form-group row mt-5">
    ...
    <div class="col-lg-9">
        <select class="form-select mb-2 js-data-example-ajax" data-control="select2" data-hide-search="false"
            data-placeholder="Select an option" name="product_ids[]" id="products"
...
<div class="form-group row mt-5">
    ...
    <div class="col-lg-9">
        ...
        name="date_range" placeholder="{{ translate('Select Date') }}" data-time-picker="true" data-format="DD-MM-Y HH:mm:ss" data-separator=" to " autocomplete="off" value="{{ $start_date .' - '. $end_date }}">
    </div>
</div>

<div class="form-group row">
    <label class="col-lg-3 col-from-label" for="coupon_code">{{translate('Discount')}}</label>
    <div class="col-lg-7">
        <input type="text" placeholder="{{translate('Discount')}}" id="discount" name="discount" class="form-control" value="{{ $coupon->discount }}" required>
    </div>
