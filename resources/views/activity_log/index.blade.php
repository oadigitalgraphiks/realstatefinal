    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Activity Log</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                    ...
                    <div class="card card-flush">
                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                            <div class="col text-md-left">
                                <h5 class="mb-md-0 h6">{{ translate('Activity Log') }}</h5>
                            </div>
                            <!--begin::Card toolbar-->
                            <form class="" id="sort_staff" action="" method="GET">
                                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                    <div class="col">
                                        ...
                                        data-placeholder="Filter by Staff" onchange="sort_staff()" id="staff_id"
                                        name="staff_id">
                                            <option value="">Filter by Staff</option>
                                            @foreach ($users as $user)
                                                <option value="{{$user->id}}" {{$staff_id == $user->id ? "selected" : "" }}>{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col">
                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                    ...
                                    <tbody>
                                        @foreach ($logs as $key => $log)
                                            @if ($log->user->user_type != "admin" && $log->log_type != "login")
                                                <tr>
                                                    <td>{{ $log->id }}</td>
