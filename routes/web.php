...
Route::post('/home/section/popular_product', 'HomeController@popular_product')->name('home.section.popular_product');
...
Route::post('/menus/mob-menu-element-list', 'HomeController@get_mob_menus_items')->name('mob.menus.elements');
...
Route::post('/cart_summary', 'CheckoutController@cart_tax')->name('cart.cart_summary');
//Checkout Routes
